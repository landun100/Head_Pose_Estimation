...
class PRNet():
    def __init__(self,image_folder,save_folder,kp=True,pose=False,dlib=True):
        save_folder = "."+save_folder
        self.parse(image_folder,save_folder,kp,pose,dlib)
    ...
    def main(self,args):
        ...
        for i, image_path in enumerate(image_path_list):
            ...
            if pos is None:
                kpt_none = np.array([])
                np.savetxt(os.path.join(save_folder, name +'kpt_failed.txt'), kpt_none)
                continue
            ...
            if args.isKpt or args.isShow:
                ...
                np.savetxt(os.path.join(save_folder, name + 'kpt.txt'), kpt)
    ...
    def parse(self,image_folder,save_folder,kp,pose,dlib):
        ...
        parser.add_argument('-i', '--inputDir', default=image_folder, type=str,
                            help='path to the input directory, where input images are stored.')
        parser.add_argument('-o', '--outputDir', default=save_folder, type=str,
                            help='path to the output directory, where results(obj,txt files) will be stored.')
        parser.add_argument('--gpu', default='0', type=str,
                            help='set gpu id, -1 for CPU')
        parser.add_argument('--isDlib', default=dlib, type=ast.literal_eval,
        ...
        parser.add_argument('--isKpt', default=kp, type=ast.literal_eval,
                            help='whether to output key points(.txt)')
        parser.add_argument('--isPose', default=pose, type=ast.literal_eval,
